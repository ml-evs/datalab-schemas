# Contributing to datalab-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
datalab-schema. These guidelines are not strict rules.
...
The datalab-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the datalab-schema technical leads
...
[issues]: https://github.com/datalab-org/datalab-schema/issues/
[pulls]: https://github.com/datalab-org/datalab-schema/pulls/
