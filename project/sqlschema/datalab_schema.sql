...
-- # Class: "Item" Description: "Represents a Item"
...
--     * Slot: name Description: A human-readable name for a thing
--     * Slot: description Description: A human-readable description for a thing
--     * Slot: ItemCollection_id Description: Autocreated FK slot
-- # Class: "ItemCollection" Description: "A holder for Item objects"
--     * Slot: id Description: 
...
CREATE TABLE "Item" (
	...
	name TEXT, 
	description TEXT, 
	"ItemCollection_id" INTEGER, 
	PRIMARY KEY (id), 
	FOREIGN KEY("ItemCollection_id") REFERENCES "ItemCollection" (id)
);